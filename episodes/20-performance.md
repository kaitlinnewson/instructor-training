...
1. Before splitting into groups, read [the rubric that is given to Instructor Trainers](demos_rubric.md)
  as a suggested framework for evaluating the online teaching demonstration sessions that are part of Instructor checkout. (Note: demos are not scored, so this rubric is for
